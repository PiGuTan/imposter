...
class Static_Data:
    def __init__(self):
        self._param_codes: {str:Param_code} = {} # deprecate
        self._custom_flag = {} # deprecate

        self._action_mapping: {str:[str]} = {}
        self._emotion_mapping: {str:[str]} = {}
        self._frame_mapping: {str:[int]} = {}
    def get_param_code_data(self): # deprecate
    ...
    @property
    def param_codes(self) -> {str:Param_code}: # deprecate
